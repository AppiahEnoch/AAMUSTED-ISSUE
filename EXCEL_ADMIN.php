...
$sql = "SELECT * FROM studentissueswithcoursedetails ORDER BY indexNumber ASC";
...
while ($row = $result->fetch_assoc()) {
    if ($lastIndexNumber != $row['indexNumber']) {
        $currentRow += 2;
...
$excelFilePath = 'Excel/ALL_STUDENT_ISSUES_WITH_COURSE_DETAILS.xlsx';
